...
router.patch("/cancel-unregistered-player/:trainingId",checkAuth, trainingsController.cancelTrainingUnregisteredPlayer);

router.delete("/:trainingId",checkAuth, trainingsController.deleteTraining);
