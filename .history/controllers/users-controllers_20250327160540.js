...
const getBirthdays = async (req, res, next) => {
  try {
    ...
    const month = today.getMonth() + 1; // JS mjeseci idu od 0-11
    const day = today.getDate();

    // Pronalazak igrača s današnjim rođendanom
    ...
    // ✅ Ispravno vraćamo odgovor klijentu
    return res.json({ players: birthdayPlayers });
  } catch (err) {
    const error = new HttpError(
